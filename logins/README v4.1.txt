...
If the installation fails, please delete the file config.php and install-blank.php (located at: /assets/includes/) and start again, also recommended to DROP database https://prnt.sc/O2yKSnmgI4AX or create new database on new install. :)
